...
-(void)prepareForSegue:(nonnull UIStoryboardSegue *)segue sender:(nullable id)sender{
    ...
    XMPPUserCoreDataStorageObject* selectUser = _resultsController.fetchedObjects[indexPath.row];
    WCChatMessageViewController* chatMessageViewController = segue.destinationViewController;
    chatMessageViewController.friend = selectUser;
}
@end
